...
def generar_audio_seduccion_edge():
    print("Iniciando generación de audio Paisa Seductor (Edge-TTS)...")
    ...
    try:
        vh = VoiceHandler()
        # Forzar provider a gtts para que use Edge-TTS internamente (Salomé)
